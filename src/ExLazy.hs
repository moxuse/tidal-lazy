...
binPats n = [
  ...
  (slow "<4 5 4 1.75>" "[0 [1 0 [1 0]]]/4 1/2 [0 1/2]/2 0 [1 0? 1]*2 1/3 [[0 1]/3 0] 0 1 0/2 1 [1 0? 0]/2 0 1 1"),
  (slow "<5 4 6 2>" "0 1*2 [1/2 [0? 1]] 1 1/2 [1 [0 [1 0]?]?]/2 1? [0 [1 0 1]?]/3 1 1 0/2 [1 1 0] 1 0 0 1")]
